            ...
            .flatMap({obClientArray -> EventLoopFuture<String> in
                ...
                if let obClientIdUnwrapped = obClientId {
                    ...
                    return obClientRegistrationClaims.httpPost(
                        ...
                        obAccountAndTransactionAPIVersion: obClientProfileConfiguration.obAccountAndTransactionAPIVersion,
                        obAccountTransactionBaseURL: obClientProfileConfiguration.obAccountAndTransactionBaseURL,
