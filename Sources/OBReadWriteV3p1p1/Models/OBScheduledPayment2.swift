...
public struct OBScheduledPayment2: Codable {
    ...
    public init(accountId: AccountId, scheduledPaymentId: String?, scheduledPaymentDateTime: Date, scheduledType: OBExternalScheduleType1Code, reference: String?, instructedAmount: OBActiveOrHistoricCurrencyAndAmount, creditorAgent: OBBranchAndFinancialInstitutionIdentification5?, creditorAccount: OBCashAccount5?) {
