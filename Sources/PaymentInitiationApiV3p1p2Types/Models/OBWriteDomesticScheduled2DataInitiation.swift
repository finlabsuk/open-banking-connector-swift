//
// OBWriteDomesticScheduled2DataInitiation.swift
//
...
public struct OBWriteDomesticScheduled2DataInitiation: Codable {
    ...
    public init(instructionIdentification: String, endToEndIdentification: String?, localInstrument: OBExternalLocalInstrument1Code?, requestedExecutionDateTime: Date, instructedAmount: OBWriteDomestic2DataInitiationInstructedAmount, debtorAccount: OBWriteDomestic2DataInitiationDebtorAccount?, creditorAccount: OBWriteDomestic2DataInitiationCreditorAccount, creditorPostalAddress: OBPostalAddress6?, remittanceInformation: OBWriteDomestic2DataInitiationRemittanceInformation?, supplementaryData: OBSupplementaryData1?) {
