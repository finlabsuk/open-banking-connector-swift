//
// OBWriteDomesticStandingOrderResponse4Data.swift
//
...
public struct OBWriteDomesticStandingOrderResponse4Data: Codable {
    ...
    public var domesticStandingOrderId: String
    ...
    public init(domesticStandingOrderId: String, consentId: String, creationDateTime: Date, status: Status, statusUpdateDateTime: Date, charges: [OBWriteDomesticConsentResponse3DataCharges]?, initiation: OBWriteDomesticStandingOrder3DataInitiation, multiAuthorisation: OBWriteDomesticResponse3DataMultiAuthorisation?) {
        self.domesticStandingOrderId = domesticStandingOrderId
    ...
    public enum CodingKeys: String, CodingKey { 
        case domesticStandingOrderId = "DomesticStandingOrderId"
