//
// OBWriteFileConsentResponse3Data.swift
//
...
public struct OBWriteFileConsentResponse3Data: Codable {
    ...
    public init(consentId: String, creationDateTime: Date, status: Status, statusUpdateDateTime: Date, cutOffDateTime: Date?, charges: [OBWriteDomesticConsentResponse3DataCharges]?, initiation: OBWriteFile2DataInitiation, authorisation: OBWriteDomesticConsent3DataAuthorisation?, sCASupportData: OBWriteDomesticConsent3DataSCASupportData?) {
