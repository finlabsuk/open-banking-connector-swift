//
// OBWriteInternationalStandingOrderConsentResponse4Data.swift
//
...
public struct OBWriteInternationalStandingOrderConsentResponse4Data: Codable {
    ...
    public init(consentId: String, creationDateTime: Date, status: Status, statusUpdateDateTime: Date, permission: Permission, cutOffDateTime: Date?, charges: [OBWriteDomesticConsentResponse3DataCharges]?, initiation: OBWriteInternationalStandingOrder3DataInitiation, authorisation: OBWriteDomesticConsent3DataAuthorisation?, sCASupportData: OBWriteDomesticConsent3DataSCASupportData?) {
