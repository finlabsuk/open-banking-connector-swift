//
// OBWriteInternationalStandingOrder3DataInitiation.swift
//
...
public struct OBWriteInternationalStandingOrder3DataInitiation: Codable {
    ...
    public var creditorAgent: OBWriteInternationalStandingOrder3DataInitiationCreditorAgent?
    public var creditorAccount: OBWriteInternationalStandingOrder3DataInitiationCreditorAccount
    public var supplementaryData: OBSupplementaryData1?

    public init(frequency: String, reference: String?, numberOfPayments: String?, firstPaymentDateTime: Date, finalPaymentDateTime: Date?, purpose: String?, chargeBearer: OBChargeBearerType1Code?, currencyOfTransfer: String, instructedAmount: OBWriteDomestic2DataInitiationInstructedAmount, debtorAccount: OBWriteDomesticStandingOrder3DataInitiationDebtorAccount?, creditor: OBWriteInternational2DataInitiationCreditor?, creditorAgent: OBWriteInternationalStandingOrder3DataInitiationCreditorAgent?, creditorAccount: OBWriteInternationalStandingOrder3DataInitiationCreditorAccount, supplementaryData: OBSupplementaryData1?) {
