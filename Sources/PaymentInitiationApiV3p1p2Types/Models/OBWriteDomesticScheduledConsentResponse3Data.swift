//
// OBWriteDomesticScheduledConsentResponse3Data.swift
//
...
public struct OBWriteDomesticScheduledConsentResponse3Data: Codable {
    ...
    public init(consentId: String, creationDateTime: Date, status: Status, statusUpdateDateTime: Date, permission: Permission, cutOffDateTime: Date?, expectedExecutionDateTime: Date?, expectedSettlementDateTime: Date?, charges: [OBWriteDomesticConsentResponse3DataCharges]?, initiation: OBWriteDomesticScheduled2DataInitiation, authorisation: OBWriteDomesticConsent3DataAuthorisation?, sCASupportData: OBWriteDomesticConsent3DataSCASupportData?) {
