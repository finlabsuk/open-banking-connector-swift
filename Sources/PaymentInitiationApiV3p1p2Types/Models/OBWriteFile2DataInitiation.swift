//
// OBWriteFile2DataInitiation.swift
//
...
public struct OBWriteFile2DataInitiation: Codable {
    ...
    public init(fileType: String, fileHash: String, fileReference: String?, numberOfTransactions: String?, controlSum: Double?, requestedExecutionDateTime: Date?, localInstrument: OBExternalLocalInstrument1Code?, debtorAccount: OBWriteDomestic2DataInitiationDebtorAccount?, remittanceInformation: OBWriteDomestic2DataInitiationRemittanceInformation?, supplementaryData: OBSupplementaryData1?) {
