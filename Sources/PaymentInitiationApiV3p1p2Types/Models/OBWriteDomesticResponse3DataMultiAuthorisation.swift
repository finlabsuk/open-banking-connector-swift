//
// OBWriteDomesticResponse3DataMultiAuthorisation.swift
//
...
public struct OBWriteDomesticResponse3DataMultiAuthorisation: Codable {
    ...
    public init(status: Status, numberRequired: Int?, numberReceived: Int?, lastUpdateDateTime: Date?, expirationDateTime: Date?) {
        self.status = status
