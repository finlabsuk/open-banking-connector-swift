//
// OBWriteDataDomesticConsentResponse2.swift
//
...
public struct OBWriteDataDomesticConsentResponse2: Codable {
    ...
    public init(consentId: String, creationDateTime: Date, status: OBExternalConsentStatus1Code, statusUpdateDateTime: Date, cutOffDateTime: Date?, expectedExecutionDateTime: Date?, expectedSettlementDateTime: Date?, charges: [OBCharge2]?, initiation: OBDomestic2, authorisation: OBAuthorisation1?) {
