...
public struct OBDomestic2: Codable {
    ...
    public init(instructionIdentification: String, endToEndIdentification: String, localInstrument: OBExternalLocalInstrument1Code?, instructedAmount: OBDomestic2InstructedAmount, debtorAccount: OBCashAccountDebtor4?, creditorAccount: OBCashAccountCreditor3, creditorPostalAddress: OBPostalAddress6?, remittanceInformation: OBRemittanceInformation1?, supplementaryData: OBSupplementaryData1?) {
