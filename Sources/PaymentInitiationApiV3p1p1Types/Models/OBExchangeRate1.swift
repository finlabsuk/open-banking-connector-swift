...
public struct OBExchangeRate1: Codable {
    ...
    public init(unitCurrency: String, exchangeRate: Double?, rateType: OBExchangeRateType2Code, contractIdentification: String?) {
