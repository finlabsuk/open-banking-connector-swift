...
public struct OBRisk1: Codable {
    ...
    public var paymentContextCode: OBExternalPaymentContext1Code?
    ...
    public init(paymentContextCode: OBExternalPaymentContext1Code?, merchantCategoryCode: String?, merchantCustomerIdentification: String?, deliveryAddress: OBRisk1DeliveryAddress?) {
