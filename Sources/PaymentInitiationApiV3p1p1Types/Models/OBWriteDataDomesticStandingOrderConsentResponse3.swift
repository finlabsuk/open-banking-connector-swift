//
// OBWriteDataDomesticStandingOrderConsentResponse3.swift
//
...
public struct OBWriteDataDomesticStandingOrderConsentResponse3: Codable {
    ...
    public init(consentId: String, creationDateTime: Date, status: OBExternalConsentStatus1Code, statusUpdateDateTime: Date, permission: OBExternalPermissions2Code, cutOffDateTime: Date?, charges: [OBCharge2]?, initiation: OBDomesticStandingOrder3, authorisation: OBAuthorisation1?) {
