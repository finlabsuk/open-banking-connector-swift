//
// OBWriteDataInternationalStandingOrderResponse3.swift
//
...
public struct OBWriteDataInternationalStandingOrderResponse3: Codable {
    ...
    public init(internationalStandingOrderId: String, consentId: String, creationDateTime: Date, status: OBExternalStatus1Code, statusUpdateDateTime: Date, charges: [OBCharge2]?, initiation: OBInternationalStandingOrder3, multiAuthorisation: OBMultiAuthorisation1?) {
