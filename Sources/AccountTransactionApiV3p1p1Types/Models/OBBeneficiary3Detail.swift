...
public struct OBBeneficiary3Detail: Codable {
    ...
    public init(accountId: AccountId?, beneficiaryId: String?, reference: String?, creditorAgent: OBBranchAndFinancialInstitutionIdentification6?, creditorAccount: OBCashAccount5) {
