...
public struct OBAccount3Basic: Codable {
    ...
    public init(accountId: AccountId, currency: ActiveOrHistoricCurrencyCode0, accountType: OBExternalAccountType1Code, accountSubType: OBExternalAccountSubType1Code, _description: Description0?, nickname: Nickname?) {
