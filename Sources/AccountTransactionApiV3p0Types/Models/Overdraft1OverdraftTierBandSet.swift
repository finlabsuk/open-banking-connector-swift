//
// Overdraft1OverdraftTierBandSet.swift
//
...
public struct Overdraft1OverdraftTierBandSet: Codable {
    ...
    public var overdraftTierBand: [Overdraft1OverdraftTierBand]
    /** Overdraft fees and charges details */
    public var overdraftFeesCharges: [Overdraft1OverdraftFeesCharges1]?

    public init(tierBandMethod: TierBandMethod, overdraftType: OverdraftType?, identification: String?, authorisedIndicator: Bool?, bufferAmount: String?, notes: [String]?, overdraftTierBand: [Overdraft1OverdraftTierBand], overdraftFeesCharges: [Overdraft1OverdraftFeesCharges1]?) {
