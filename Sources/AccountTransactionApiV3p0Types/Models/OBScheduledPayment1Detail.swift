//
// OBScheduledPayment1Detail.swift
//
...
public struct OBScheduledPayment1Detail: Codable {
    ...
    public init(accountId: AccountId, scheduledPaymentId: String?, scheduledPaymentDateTime: Date, scheduledType: OBExternalScheduleType1Code, reference: String?, instructedAmount: OBActiveOrHistoricCurrencyAndAmount, creditorAgent: OBBranchAndFinancialInstitutionIdentification4?, creditorAccount: OBCashAccount3) {
